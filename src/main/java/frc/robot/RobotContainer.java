...
public class RobotContainer {
                                                ...
                                                new IntakePivotCommand(m_IntakeSubsystem)
                                                                ...
                                                                .andThen(
                                                                                new TeleopHandoffCommand(
                                                                                                ...
                                                                                                .withTimeout(2.0)
                                                                // new HandoffAutoCommand(m_IntakeSubsystem,
                                                                // m_ShooterSubsystem, false).withTimeout(2.0)
                                                                )
                                // )
                                );
        ...
        private void registerNamedCommands() {
                ...
                NamedCommands.registerCommand(
                                ...
                                new HandoffAutoCommand(m_IntakeSubsystem, m_ShooterSubsystem, true)
                                                .onlyIf(() -> !m_IntakeSubsystem.getBeamState()));
                NamedCommands.registerCommand(
                                "PrepPivot",
                                new Command() {
                                });
        ...
        private void initializeAutoShuffleboard() {
                ...
                // autoTab.add("Angle to Speaker", new Rotate(m_SwerveSubsystem,
                // m_VisionSubsystem, autoManager));
        ...
        public Command getLEDCommand() {
                ...
                // || (driverController_HID.getRightBumper() > OIConstants.kDeadband &&
                // m_ShooterSubsystem.getShooterVelocity() > ShooterConstants.AmpRPM - 250))
                );
        }
