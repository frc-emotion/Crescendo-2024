...
import frc.robot.commands.Auto.SubsystemCommands.PivotToHandoffCommand;
...
public class RobotContainer {
        ...
        m_ShooterSubsystem.setDefaultCommand(
                new ShooterManualCommand(
                        () -> operatorController_HID
                                .getLeftTriggerAxis() > OIConstants.kDeadband,
                        () -> operatorController_HID
    ...
    private void configureBindings() {
                ...
                .whileFalse(
                        new IntakePivotCommand(m_IntakeSubsystem)
                                ...
                                .alongWith(
                                        ...
                                        // }
                                        // #endregion
                                        new PivotToHandoffCommand(
                                                m_PivotSubsystem)
                                                .onlyIf(() -> !m_PivotSubsystem
                                                        .isHandoffOk())
                                                .withTimeout(3.5))
                                .andThen(
                                        // #region
        ...
        m_operatorController.b().whileTrue(
                new Command() {
                    ...
                    public void execute() {
                        m_ShooterSubsystem
                                .setShooterRaw(ShooterConstants.SHOOTER_REVERSE_SPEED);
                        m_ShooterSubsystem
                                .setFeederSpeed(ShooterConstants.FEEDER_REVERSE_SPEED);
                    }
        ...
        m_operatorController.a().whileTrue(
                new Command() {
                    ...
                    public void execute() {
                        m_IntakeSubsystem.setIntake(IntakeConstants.SHOOTER_TRANSFER_SPEED);
                        m_ShooterSubsystem
                                .setFeederSpeed(IntakeConstants.SHOOTER_TRANSFER_SPEED);
                    }
    ...
    private void registerNamedCommands() {
        NamedCommands.registerCommand("ScoreSpeaker",
                new ParallelRaceGroup(new ShootSpeaker(m_ShooterSubsystem, m_IntakeSubsystem),
                        new WaitCommand(5))); // .withTimeout(AutoConstants.SCORE_SPEAKER_TIMEOUT));
    ...
    private void initializeGameShuffleboard() {
        ...
        gameShuffleboardTab.addBoolean("Debug Mode", () -> Constants.DEBUG_MODE_ACTIVE).withPosition(10, 4)
                .withSize(3,
                        1);
        ...
        ShuffleboardLayout generalLayout = gameShuffleboardTab.getLayout("Drive Mode", BuiltInLayouts.kGrid)
                .withPosition(5, 0).withProperties(Map.of("Number of columns", 4, "Number of Rows", 1))
                .withSize(5, 2);
        ...
        generalLayout.addBoolean("Normal Mode Active",
        ...
        ShuffleboardLayout intakeLayout = gameShuffleboardTab.getLayout("Intake Data", BuiltInLayouts.kGrid)
                ...
                .withSize(5, 2);
        intakeLayout.addBoolean("Intake Down", () -> !m_IntakeSubsystem.isUp())
                .withWidget(BuiltInWidgets.kBooleanBox);
        ...
        ShuffleboardLayout motorLayout = gameShuffleboardTab.getLayout("Motor Data", BuiltInLayouts.kGrid)
                .withProperties(Map.of("Number of columns", 2, "Number of rows", 1)).withPosition(8, 3)
                .withSize(2, 1);
